...
VALUES
(1, "Supplier", "Terma", "482034578", "terma@terma.pl", "terma123", null, null, null, NOW(), true),
(2, "Supplier", "Purmo", "482074578", "purmo@purmogroup.com.pl", "purmo123", null, null, null, NOW() - INTERVAL 1 WEEK, true),
(3, "Supplier", "Grohe", "600700800", "grohe@grohe.de", "grohe123", null, null, null, NOW() - INTERVAL 12 WEEK, true),
(4, "Supplier", "TECE", "678876321", "tece@tece.pl", "tece123", null, null, null, NOW() - INTERVAL 10 MONTH, true);
...
INSERT INTO `DetailsDeliveryOrders`
  (`DeliveryOrderId`, `LineNum`, `BaseRef`, `SupplierId`, `UserId`, `ItemCode`, `ItemName`, `Quantity`, `CodeBars`, `Price`, `Currency`, `LineTotal`, `LineVat`, `DiscountPrcnt`, `VatPrcnt`, `VatGroup`, `Active`, `OnTheWay`, `ScheduledShipDate`, `CreationDate`, `ModifyDate`)
VALUES
